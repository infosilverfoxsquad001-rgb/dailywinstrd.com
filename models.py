...
class User(UserMixin, db.Model):
    ...
    referred_by_id = db.Column(db.Integer, db.ForeignKey("users.id"), nullable=True, index=True)
    ...
    investment_balance = db.Column(db.Float, default=0.0, nullable=False)
    ...
    kyc_status = db.Column(db.String(20), default="Not Submitted", nullable=False)
...
class PaymentSetting(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    usdt_address = db.Column(db.String(255), default="", nullable=False)
    btc_address = db.Column(db.String(255), default="", nullable=False)
    eth_address = db.Column(db.String(255), default="", nullable=False)
    bank_info = db.Column(db.Text, default="", nullable=False)
...
class SupportMessage(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    conversation_token = db.Column(db.String(64), nullable=False, index=True)
    user_id = db.Column(db.Integer, db.ForeignKey("users.id"), nullable=True, index=True)
    sender = db.Column(db.String(20), nullable=False)  # user | support
